...
These are write-ups from two rooms I completed - one lives in application code, the other in the infrastructure underneath it. Turns out breaking things has layers.
